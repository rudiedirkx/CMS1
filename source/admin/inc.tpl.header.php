...
<div class="userinfo">[<a href="/admin/">Home</a>] | Ingelogd als: <?=$g_objAdmin->name?> (<?=$g_objAdmin->username?>) (<?=$g_objAdmin->user_type?>) | <a href="/admin/login.php?logout=1">uitloggen</a> | <a href="/admin/logs.php">logs</a> | <a href="/admin/routes.php">routes</a></div>
