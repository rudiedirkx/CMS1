...
smarty_core_load_plugins(array('plugins' => array(array('function', 'load', '/SERVER/www/websites/CMS1/source/resources/subumbra/views/4.php', 1, false),)), $this); ?>
...
" /></a></p>
<?php $this->assign('prev', $this->_tpl_vars['this']->getPrevImage());$this->assign('next', $this->_tpl_vars['this']->getNextImage()); ?><p><a<?php if ($this->_tpl_vars['prev']): ?> href="<?php echo $this->_tpl_vars['prev']->relative_url; ?>
