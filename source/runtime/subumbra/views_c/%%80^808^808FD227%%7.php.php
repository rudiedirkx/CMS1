...
?>
<?php $this->assign('ws', $this->_tpl_vars['entry']->website); ?><?php if ($this->_tpl_vars['ws'] && ! ((is_array($_tmp=$this->_tpl_vars['ws'])) ? $this->_run_mod_handler('startswith', true, $_tmp, 'http://') : smarty_modifier_startswith($_tmp, 'http://'))): ?><?php $this->assign('ws', "http://".($this->_tpl_vars['ws'])); ?><?php endif; ?>
<div class="entry">
