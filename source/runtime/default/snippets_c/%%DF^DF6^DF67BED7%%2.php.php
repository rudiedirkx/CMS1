...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'startswith', '/SERVER/www/websites/CMS1/source/resources/default/snippets/2.php', 15, false),array('modifier', 'count', '/SERVER/www/websites/CMS1/source/resources/default/snippets/2.php', 20, false),)), $this); ?>
<html>
...
<div id="menu">
<ul>
<?php $this->assign('mi', $this->_tpl_vars['this']->load('menu'));
 ?><?php $this->assign('mi', $this->_tpl_vars['mi']->getMenuItems());
 ?>
